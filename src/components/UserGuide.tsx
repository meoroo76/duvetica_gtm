...
const sections = [
  {
    ...
    content: [
      ...
      '- 한 화면에 최대 2개 시즌이 나란히 표시되어 겹치는 일정을 한눈에 파악 가능',
  ...
  },
  {
    ...
    content: [
      ...
      '',
      '[ 캘린더 표시 ]',
      '- 캘린더에는 항상 최신 2개 시즌만 표시됩니다 (최신 시즌이 좌측)',
      '- 시즌 필터에서 특정 시즌만 선택하여 볼 수도 있습니다',
    ...
    <div className="flex h-full">
      ...
      <div className="w-[220px] bg-gray-50 border-r border-gray-200 overflow-y-auto shrink-0">
        <div className="p-4 border-b border-gray-200">
          ...
          <p className="text-[10px] text-gray-400 mt-0.5">DUVETICA GTM v2.0</p>
        </div>
        <nav className="p-2">
          {sections.map((s) => (
            <button
