...
const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      '',
      '[ 키보드 단축키 (셀 선택 후) ]',
      '- 셀을 클릭하면 검은 테두리로 선택됩니다',
      '- Ctrl+C: 선택된 셀의 일정을 복사',
      '- Ctrl+X: 선택된 셀의 일정을 잘라내기 (반투명 표시)',
      '- Ctrl+V: 선택된 셀에 복사/잘라낸 일정을 붙여넣기',
      '- 잘라내기 후 붙여넣기하면 원본이 삭제됩니다',
      '- 복사/잘라내기 상태는 필터 바에 표시되며, ✕ 버튼으로 취소 가능',
    ],
  },
  {
    id: 'comparison',
